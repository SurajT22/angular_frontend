...
export class ApiClientService{
    ...
    getRegulatory():Observable<RegulatoryDetail[]>{
     ...
     getAllClientsIp():Observable<string[]>{
        return this.api.get(`${this.baseUrl}/webapi_Clientregistration_GetClientRequestIpList`);
     }
    getSelectedClientIp(ip:string):Observable<Client>{
        return this.api.get(`${this.baseUrl}/webapi_Clientregistration_GetSelectedClientRequestDetails?Ip=${ip}`);
    }
}